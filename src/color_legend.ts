 ...
 */
module.directive('colorLegends', function() {
  return {
    restrict: 'E',
    template: '<div class="someOtherClass"><svg width="16.5rem" height="24px"></svg></div>',
 ...
 */
module.directive('heatmapLegends', function() {
  return {
    restrict: 'E',
    template: `<div class="someclass"><svg width="${LEGEND_WIDTH_PX}px" height="${LEGEND_HEIGHT_PX}px"></svg></div>`,
    link: function(scope: any, elem, attrs) {
      let ctrl = scope.ctrl;
      let panel = scope.ctrl.panel;
